...
$(document).on('pageinit', '#page-map', function() {
	map = L.map('map', {center: [51.107885, 17.038538], zoom: 14, layers: osm_color, maxBounds: map_bounds});
...
showNotification('Powiadomienie', 'Strona wykorzystuje pliki cookies służące w celach logowania oraz zbierania statystyk z usługi Google Analytics.');