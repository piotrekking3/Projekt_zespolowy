...
// Powiadomienie toast
function showToast(_message, _opacity, _temporary, _delay, _x, _y) {
	var $toast = $("<div class=\"ui-loader ui-overlay-shadow ui-body-e ui-corner-all\" style=\"cursor: pointer\"><p style=\"font-size: 90%;\">" + _message + "</p></div>");
	$toast.css({
		display: 'block', 
		background: '#fff',
		opacity: _opacity, 
