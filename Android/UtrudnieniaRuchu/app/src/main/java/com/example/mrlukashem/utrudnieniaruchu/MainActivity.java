...
public class MainActivity extends ActionBarActivity
    ...
    public boolean areFormFieldsNull() {
        return (tempContentFromNewMarkerForm == null)
                && (tempEmailFromNewMarkerForm == null);
    }
    ...
    @Override
    public void sendFormData(String __email, int __category_id, String __content) {
    ...
    @Override
    public void addMarkerFromFormData() {
        if(areFormFieldsNull()) {
            throw new NullPointerException("Marker form fields are null");
        }
